...
$day = date('Y/n/j (D)',strtotime($datePointer." days"));
   ...
   */
   ...
   echo "<td style='width:500px;'><div class='rcorners_top' style='height:150px;padding-top:20px;background-color:#eeeeee;color:#black;font-size:60px;font-family:impact;font-weight:900;text-align:center;'>Add entry</div></td>";
   echo "<td style='width:500px;'><div class='rcorners_top' style='height:150px;padding-top:20px;background-color:#aaaaaa;color:#cccccc;font-size:60px;font-family:impact;font-weight:900;text-align:center;'>Health log</div></td>";
   echo "<td style='width:500px;'><div class='rcorners_top' style='height:150px;padding-top:20px;background-color:#aaaaaa;color:#cccccc;font-size:60px;font-family:impact;font-weight:900;text-align:center;'>Todo list</div></td>";
   echo "</tr></table>";

   
   echo "<table border=0 width=100% style='margin-top:10px;'><tr>";
   echo "<td style='height:100px;width:220px;font-family:impact;font-size:40px;font-weight:900;color:#ffffff;'>";
      echo "代號: ";
      echo "<input class='rcorners1' id='shortID' type='text' name='T1' size='20' style='text-align:center;height:100%;width:190px;background-color:#ffffff;font-weight:900;font-family:impact;font-size:50px; border:3px #cccccc solid;' value='$simpleID'>";
   echo "</td><td style='width:500px;'>";
      
      echo "<table class='rcorners1' width='100%' height='150' border=0 style='background-color:#eeeeee;'><tr>";
         echo "<td style='font-family:impact;font-size:40px;text-align:right;'>Health log</td>";
         echo"<td style='text-align:center;'>
         <label class='switch'>
           <input type='checkbox' id='taskSwitchBox' onchange='javascript:taskSwitch();'>
           <div class='slider round'></div>
         </label></td>";
         echo "<td style='font-family:impact;font-size:40px;text-align:left;'>Todo</td>";
      echo "</td><td colspan='3' style='width:80px;height:60px;' valign=middle>";
         echo "<div id='taskFinishPanel' style='display:none;text-align:left;'><input type='checkbox' name='C1' value='ON' style='width:70px;height:70px;'></div>";
      echo "</td></tr></table>";
   echo "</td></tr></table>";
...
echo "<textarea id='note' name='T1' size='20' rows='3' style='font-family:impact;font-size:40px;font-weight:500;margin-top:10px;width:100%;background-color:#fff;height:120px; border:3px #cccccc solid;'></textarea>";
echo "<iframe id='actionCards_iframe' width='100%' height='880' frameborder=0 src='actionCards.php'></iframe>";

echo "<table width=100% border=0><tr>";
echo "<td width=50%><div class='rcorners1' style='padding-top:10px;margin-top:10px;width:300px;text-align:center;font-family:impact;font-size:80px;font-weight:700;background-color:#cccccc; height:120px; color:white;'' onclick='javascript:history.back()'>&larr;</div></td>";
echo "<td width=50%><div class='rcorners1' style='padding-top:10px;margin-top:10px;width:100%;text-align:center;font-family:impact;font-size:80px;font-weight:700;background-color:#00B050; height:120px; color:white;' onclick='javascript:location.href=\"device_standby.php?sound=none\"'>儲存</div></td>";
echo "</tr></table>";
?>
